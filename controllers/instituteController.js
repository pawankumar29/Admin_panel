...
function dataUpload(req, path) {
    // let organisation_id = req.user.organisation_id
    let organisation_id = mongoose.Types.ObjectId('5c36ebf4f3c3a07b3163a6e7')
    let invalidArray = [];
    let validArray = [];
    let csvDataArray = [];
    let emailArray = [];
                ...
                users
                    ...
                    .then(userData => {
                        if (userData.status == 1) {
                            console.log("already exist users");
                            ...
                            csvDataArray.forEach((obj, index) => {
                                ...
                                if (obj["email"]) {
                                    if (moment(obj["dob"], "mm/dd/yyyy", true).isValid()) {
                                        ...
                                        obj["message"] = "dob format is not correct missing.";
